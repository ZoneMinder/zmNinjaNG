...
- Are an experienced programmer in at least one language
- Understand basic programming concepts (variables, functions, classes, etc.)
- May not be familiar with React, JavaScript ecosystem, or frontend development
- Want to understand the architecture and patterns used in zmNg

If you're coming from backend development, Java, C++, Python, or similar languages, we'll explain React concepts from first principles.

## What This Guide Covers

### Core Concepts (Chapters 2-4)
- **React Fundamentals**: How React works, components, hooks, and rendering
- **State Management with Zustand**: How we manage application state
- **Infinite Loops Explained**: A deep dive into a common pitfall we encountered
...
1. Start with **Chapter 2: React Fundamentals** - understand the mental model
2. Read **Chapter 3: State Management** - understand how data flows
3. Study **Chapter 4: Infinite Loops** - learn from our mistakes
4. Review **Chapter 6: Testing Strategy** - understand how to verify your changes
...
Throughout this guide, we use real examples from the zmNg codebase. File paths are shown relative to the `app/` directory:
...
Continue to [Chapter 2: React Fundamentals](./02-react-fundamentals.md) to understand the foundation of how this application works.
