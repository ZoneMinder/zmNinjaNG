...
/** Loads the model if it is not already loaded. Split out of `chat` so the app
 *  can tell the user why the first turn is slow: loading a 2B model takes
 *  seconds, and folded into `chat` it was indistinguishable from generation. */
