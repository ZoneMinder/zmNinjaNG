...
+ (nullable NSString *)loadAtConfigPath:(NSString *)configPath useGpu:(BOOL)useGpu error:(NSError **)error;
...
+ (nullable NSDictionary *)chatAtConfigPath:(NSString *)configPath messages:(NSArray<NSDictionary<NSString *, NSString *> *> *)messages maxTokens:(NSInteger)maxTokens useGpu:(BOOL)useGpu error:(NSError **)error;
+ (void)unload;
@end
